...
public class Grid <TGridObject>
{
    ...
    private TGridObject[,] debugTextArray;


    public Grid(int width, int height, float cellSize, Vector3 originPosition, Func<Grid<TGridObject>, int, int, TGridObject> createGridObject, bool showDebug = default(bool))
    {
        this.width = width;
        this.height = height;
